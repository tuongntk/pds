...
using FirstNews.Core.ObjectMapping;
...
namespace FirstNews.Core
{
    ...
    /// </summary>
    public abstract class FirstNewsServiceBase
    {
        /// <summary>
        ...
        public IUnitOfWorkManager UnitOfWorkManager
        {
            get
            {
                ...
                {
                    throw new FirstNewsException("Must set UnitOfWorkManager before use it.");
                }
        ...
        protected ILocalizationSource LocalizationSource
        {
            get
            {
                ...
                {
                    throw new FirstNewsException("Must set LocalizationSourceName before, in order to get LocalizationSource");
                }
        ...
        /// Constructor.
        /// </summary>
        protected FirstNewsServiceBase()
        {
