...
using FirstNews.Core.Events.Bus.Factories;
using FirstNews.Core.Events.Bus.Factories.Internals;
using FirstNews.Core.Events.Bus.Handlers;
using FirstNews.Core.Events.Bus.Handlers.Internals;
using FirstNews.Core.Extensions;
using FirstNews.Core.Threading;
using FirstNews.Core.Threading.Extensions;
using Castle.Core.Logging;
using FirstNews.Core.Utils;

namespace FirstNews.Core.Events.Bus
{
    /// <summary>
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new FirstNewsException(message));
                    }
                }
            }
