...
using FirstNews.Core.Runtime.Security;
    ...
    public class ClaimsSession : SessionBase, ISingletonDependency
    {
        public override long? UserId
        {
            get
            {
                ...
                var userIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c => c.Type == Security.FirstNewsClaimTypes.UserId);
        ...
        public override int? TenantId
        {
            get
            {
                ...
                var tenantIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c => c.Type == Security.FirstNewsClaimTypes.TenantId);
        ...
        public override long? ImpersonatorUserId
        {
            get
            {
                var impersonatorUserIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c => c.Type == Security.FirstNewsClaimTypes.ImpersonatorUserId);
        ...
        public override int? ImpersonatorTenantId
        {
            get
            {
                ...
                var impersonatorTenantIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c => c.Type == Security.FirstNewsClaimTypes.ImpersonatorTenantId);
