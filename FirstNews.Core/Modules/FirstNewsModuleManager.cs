...
namespace FirstNews.Core.Modules
{
    ...
    public class FirstNewsModuleManager : IFirstNewsModuleManager
    {
        ...
        private List<Type> FindAllModuleTypes(out List<Type> plugInModuleTypes)
        {
            ...
            var modules = FirstNewsModule.FindDependedModuleTypesRecursivelyIncludingGivenModule(_modules.StartupModuleType);
        ...
        private void CreateModules(ICollection<Type> moduleTypes, List<Type> plugInModuleTypes)
        {
            ...
            {
                var moduleObject = _iocManager.Resolve(moduleType) as FirstNewsModule;
        ...
        private void SetDependencies()
        {
            foreach (var moduleInfo in _modules)
            {
                ...
                foreach (var dependedModuleType in FirstNewsModule.FindDependedModuleTypes(moduleInfo.Type))
                {
