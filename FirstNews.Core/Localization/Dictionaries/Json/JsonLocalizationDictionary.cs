...
namespace FirstNews.Core.Localization.Dictionaries.Json
{
    /// <summary>
    ...
    public class JsonLocalizationDictionary : LocalizationDictionary
    {
        ...
        public static JsonLocalizationDictionary BuildFromFile(string filePath)
        {
            ...
            {
                throw new FirstNewsException("Invalid localization file format! " + filePath, ex);
            }
        }
        ...
        public static JsonLocalizationDictionary BuildFromJsonString(string jsonString)
        {
            ...
            {
                throw new FirstNewsException("Can not parse json string. " + ex.Message);
            }

            var cultureCode = jsonFile.Culture;
            if (string.IsNullOrEmpty(cultureCode))
            {
                throw new FirstNewsException("Culture is empty in language json file.");
            }
            ...
            foreach (var item in jsonFile.Texts)
            {
                ...
                {
                    throw new FirstNewsException("The key is empty in given json string.");
                }
