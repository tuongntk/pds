    ...
    internal class LocalizationManager : ILocalizationManager
    {
        ...
        private void InitializeSources()
        {
            ...
            foreach (var source in _configuration.Sources)
            {
                ...
                {
                    throw new FirstNewsException("There are more than one source with name: " + source.Name + "! Source name must be unique!");
                }
        ...
        public ILocalizationSource GetSource(string name)
        {
            ...
            {
                throw new FirstNewsException("Can not find a source with name: " + name);
            }
