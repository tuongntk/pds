...
namespace FirstNews.Core.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new FirstNewsException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new FirstNewsException("Complete is called before!");
            }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new FirstNewsException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
